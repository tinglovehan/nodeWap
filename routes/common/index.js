...
var common = {
    ...
    commonRequest: function (_p) {
        ...
        _p.__proto__ = opt;
        var _a = new Array(),
            _o = { 'content-type': 'text/html;charset=utf-8', headers: { 'access-token': _p.req.session.token || "",'cookies': typeof _p.req.cookies['connect.sid'] !== 'undefined' ?  _p.req.cookies : { 'sendinfo': 'hswap'} }, timeout: 100000 };
        _p.url
            .map(function (item, index) {
